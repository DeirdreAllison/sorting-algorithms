...
describe Sorting do
  ...
  it 'should return a sorted array using radix sort' do
    Sorting.new.radix_sort([3, 7, 23, 1]).must_equal [1, 3, 7, 23]
  end
  ...
  it 'is benchmarked for insertion sort' do
    ...
    puts Benchmark.measure { Sorting.new.radix_sort((1..10_000).to_a) }
    ...
    puts Benchmark.measure { Sorting.new.radix_sort(10_000.downto(1).to_a) }
    ...
    puts Benchmark.measure { Sorting.new.radix_sort((1..10_000).to_a.shuffle) }
